...
const baseCssPath = path.resolve(__dirname, '../packages/common/index.ttss');
...
tasks.buildExample = gulp.series(
  ...
  gulp.parallel(
      ...
      appJson.pages
        ...
        .forEach((path) => {
          ...
          const writeFiles = [
            ...
            {
              path: `${examplePagesDir}/${component}/index.ttml`,
    ...
    () => {
      ...
      gulp.watch(`${src}/**/*.ttml`, copier(exampleDistDir, 'ttml'));
      gulp.watch(`${src}/**/*.sjs`, copier(exampleDistDir, 'sjs'));
